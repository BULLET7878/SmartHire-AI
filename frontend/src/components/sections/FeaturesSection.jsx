        ...
        <section className="py-24 px-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {features.map((feature, idx) => (
                    <div key={idx} className="card hover:-translate-y-2 transition-transform duration-300 bg-white/5 border border-white/5 p-6 rounded-2xl relative overflow-hidden group">
                        ...
                        <h3 className="text-lg font-semibold mb-2 relative z-10 text-white">{feature.title}</h3>
                        <p className="text-gray-400 text-sm relative z-10 leading-relaxed">{feature.description}</p>
                    </div>
                ))}
            </div>
        </section>
