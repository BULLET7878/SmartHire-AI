        ...
        <footer className="w-full border-t border-white/5 bg-black/60 backdrop-blur-md py-8 mt-auto z-10 relative">
            <div className="max-w-[1440px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-black italic tracking-tighter uppercase">SmartHire AI</span>
                </div>
                ...
                <div className="flex gap-6">
                    <a href="https://github.com/BULLET7878" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors">
